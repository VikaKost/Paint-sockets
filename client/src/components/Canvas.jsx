...
const Canvas = observer(() => {
    ...
    const connectHandler = () => {
        canvasState.setUsernane(usernameRef.current.value);
        setShow(false)
    }
    ...
    return(
        ...
        <Modal.Footer>
          <Button variant="secondary" onClick={() => connectHandler()}>
            ...
            <canvas ref={canvasRef} width={600} height={600} onMouseDown={() => mouseDownHandler()} onMouseUp={() => mouseUpHandler()}></canvas>
        </div>
    )
});
